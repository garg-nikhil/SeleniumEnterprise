...
public class InfluxDBLogger {
  ...
  private static final String token =
      "o2AmNH6TXe2qGISfPhHFeCp6JPA1tZGCrqSlBSyWV2ipD8AE-EEenEaFqSptsEbN9xvGABG7dhn98ltj1HbtJw==";
  ...
  static {
    try {
      client =
          InfluxDBClientFactory.create("http://localhost:8086", token.toCharArray(), org, bucket);
    } catch (Exception e) {
  ...
  public static void logTestResult(
      String testName, String status, String browser, long durationMs) {
    if (client == null) {
    ...
    try (WriteApi writeApi = client.getWriteApi()) {
      Point point =
          Point.measurement("test_execution_v4")

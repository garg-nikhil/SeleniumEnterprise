...
public class HomePageTests extends BaseTests {
  ...
  public void amazonIphone() {
    ...
    List<WebElement> suggesttionList =
        driver.findElements(By.xpath("//*[@class='s-suggestion s-suggestion-ellipsis-direction']"));
  ...
  public void makeMyTrip() {
    ...
    driver
        .findElement(By.xpath("//*[@class='dateInnerCell']/child::p[text()=" + date + "]"))
        .click();
